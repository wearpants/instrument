...
Report bugs at https://github.com/wearpants/instrument/issues
...
The best way to send feedback is to file an issue at https://github.com/instrument/wearpants/issues.
...
Ready to contribute? Here's how to set up `instrument` for local development. Please note this documentation assumes
you already have `virtualenv` and `Git` installed and ready to go.

1. Fork the `instrument` repo on GitHub.
2. Clone your fork locally::

  .. code-block:: bash

    $ cd path_for_the_repo
    $ git clone git@github.com:YOUR_NAME/instrument.git
...
3. Assuming you have virtualenv installed (If you have Python3.5 this should already be there), you can create a new environment for your local development by typing::
  ...
  .. code-block:: bash
    ...
    $ virtualenv instrument-env
    $ source instrument-env/bin/activate
...
6. The next step would be to run the test cases. `instrument` uses py.test, you can run PyTest. Before you run pytest you should ensure all dependancies are installed::
...
3. The pull request should work for Python 2.7, 3.4, 3.5 & 3.6, and for PyPy 2 and 3. Check
   https://travis-ci.org/weapants/instrument/pull_requests
...
.. instrument: https://github.com/weapants/instrument
